...
TARGET_GLOBAL_OBJCXXFLAGS ?=
TARGET_GLOBAL_FFLAGS ?=
...
# Specify ObjC++ to the compiler
HOST_GLOBAL_OBJCXXFLAGS += $(HOST_GLOBAL_OBJCFLAGS) -ObjC++
TARGET_GLOBAL_OBJCXXFLAGS += $(TARGET_GLOBAL_OBJCFLAGS) -ObjC++
